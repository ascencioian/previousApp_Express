...
app.put('/questions', (req, res) => {
  db.collection('words')
  .findOneAndUpdate({word: req.body.word, backwards: req.body.backwards, result: req.body.result}, {
    $inc: {
      question: 1,
    }
  }, {
...
app.delete('/words', (req, res) => {
  ...
  db.collection('words').findOneAndDelete({word: req.body.word, backwards: req.body.backwards, result: req.body.result}, (err, result) => {
